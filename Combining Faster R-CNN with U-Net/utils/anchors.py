...
#--------------------------------------------#
#   Generate the underlying prior box
#--------------------------------------------#
...
#--------------------------------------------#
#   The basic prior frame is extended to all feature points
#--------------------------------------------#
def _enumerate_shifted_anchor(anchor_base, feat_stride, height, width):
    #---------------------------------#
    #   Calculate the grid center point
    #---------------------------------#
    ...
    #---------------------------------#
    #   9 prior boxes on each grid point
    #---------------------------------#
